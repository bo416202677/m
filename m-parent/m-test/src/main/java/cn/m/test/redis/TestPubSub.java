...
public class TestPubSub extends JedisPubSub {
	...
	private static final Logger LOGGER = Logger.getLogger(TestPubSub.class);

	@Override
	public void onMessage(String channel, String message) {
		LOGGER.info("onMessage: channel[" + channel + "], message["
				+ message + "]");
	}

	@Override
	public void onPMessage(String pattern, String channel, String message) {
		LOGGER.info("onPMessage: channel[" + channel + "], message["
				+ message + "]");
	}
